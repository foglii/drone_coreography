...
if __name__ == "__main__":
  ...
  traj1.loadcsv('part1_.csv')
  traj2= uav_trajectory.Trajectory()
  traj2.loadcsv('part2_.csv')
  traj3= uav_trajectory.Trajectory()
  traj3.loadcsv('part3_.csv')
  traj4= uav_trajectory.Trajectory()
  traj4.loadcsv('part4_.csv')
  traj5= uav_trajectory.Trajectory()
  traj5.loadcsv('part5_.csv')
  traj6= uav_trajectory.Trajectory()
  traj6.loadcsv('part6_.csv')
...
animate_trajectories(trajectory_animate, out_name='outputt.mp4', fps=20,xlim=(-1,1), ylim=(-1,1), zlim=(0,2)) 
