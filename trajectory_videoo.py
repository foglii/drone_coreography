...
if __name__ == "__main__":
  ...
  traj1.loadcsv('circle1_.csv')
  traj2= uav_trajectory.Trajectory()
  traj2.loadcsv('circle2_.csv')
  traj3= uav_trajectory.Trajectory()
  traj3.loadcsv('circle3_.csv')
  traj4= uav_trajectory.Trajectory()
  traj4.loadcsv('circle4_.csv')
  traj5= uav_trajectory.Trajectory()
  traj5.loadcsv('circle5_.csv')
  traj6= uav_trajectory.Trajectory()
  traj6.loadcsv('circle6_.csv')
  # traj1=uav_trajectory.Trajectory()
  # traj2=uav_trajectory.Trajectory()
  # traj3=uav_trajectory.Trajectory()
  # traj4=uav_trajectory.Trajectory()
